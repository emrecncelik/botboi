...
class dc_telegram_bridge():
    ...
    def __init__(self,tgm_group_user_ids,bot):
        ...
        self.usable_functions_dc = [self.add_tgm_dc_pair,self.remove_tgm_dc_pair,self.call_for_5_adat,self.run_function]
        ...
        if(function_index < 0):
            ...
            #TODO: Give arguments dynamically regarding the number of parameters
                ...
                try:
                    ...
                    return("Something gone terribly wrong. Dev check this out:"+str(self.usable_functions_dc[function_index].__name__)+":"+str(argv[2:]))
